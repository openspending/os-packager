      ...
      function() {
        ...
        var convertCompletionToSuggestion = function(completion) {
          return {
            ...
            text: completion.displayName + ' ('+_.trimEnd(completion.type, ':').replace(/:/g,sep)+')',
          ...
          link: function($scope, element, attr, ctrl) {
            ...
            $(input).typeahead({
              ...
              source: function(query, sync) {
                ...
                sync(_.map(ot.autoComplete(query), convertCompletionToSuggestion));
              },
              ...
              templates: {
                suggestion: function(sugg) {
                  ...
                  return '<div class="suggestion-content '+ groupClass +'">' +
                            '<div>' + group + ret + '</div>' +
                            '<div class="suggestion-tooltip">' + sugg.description + '</div>' +
                        '</div>';
                }
              }
            });
